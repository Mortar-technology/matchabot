...
module.exports = {
    name: "phanhoi",
    category: "channell",
    description: "\`cung cấp cho Matcha Synthetic một phản hồi để có thêm ý kiến nâng cấp bot \`",
    ...
    await message.channel.send(`💯 \`đã gửi phản hồi đến cho Matcha Synthetic!\``)
    }
}
